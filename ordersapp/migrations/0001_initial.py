# Generated by Django 3.2 on 2021-07-02 13:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'передан в обработку'), ('PD', 'оплачен'), ('PRD', 'обработан'), ('RDY', 'готов'), ('CNC', 'отменен'), ('DVD', 'доставлен')], default='FM', max_length=3, verbose_name='статус')),
